...
public class Ex32 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Valor total sem desconto: R$" + (new DecimalFormat("#,##0.00").format(valor)+ " reais."));
		System.out.println("Tipo de pagamento: " + tipopagamento);
		System.out.println("Valor do desconto: R$"+  (new DecimalFormat("#,##0.00").format(desconto)+ " reais."));
		System.out.printf("Valor total a pagar com desconto: R$ " + (new DecimalFormat("#,##0.00").format(valordesconto)+ " reais" ));
