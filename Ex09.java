...
public class Ex09 {
	...
	System.out.println("Digite o sexo do indivíduo: (M- Masculino ou F- Feminino)");
	...
	System.out.println("O indivíduo do sexo "+sexo+ " peso: "+pesoF+" altura: "+ (new DecimalFormat("#,##0.00").format(alturaF))+" e"+idealpeso+" para a sua altura." );
