...
public class Ex31 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Valor a ser pago com desconto de 10% R$ " +(new DecimalFormat("#,##0.00").format (valordesconto)+ " reais."));
		System.exit(0);		
		}
		System.out.println("Valor a ser pago: R$ " + (new DecimalFormat("#,##0.00").format(total)+ " reais."));
		entrada.close();
