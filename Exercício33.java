...
public class Exercício33 {
	...
	public static void main(String[] args) {
		...
		if("d".equals(Gabarito2)) {
			System.out.println("Questão 2: " + Gabarito2 + " : Correto");
			pontuacao = pontuacao+1;
		}else {
			System.out.println("Questão 2: " + Gabarito2 + " : Errada, resposta correta(d)");
		}
		...
		if("c".equals(Gabarito4)) {
			System.out.println("Questão 4: " + Gabarito4 + " : Correto");
			pontuacao = pontuacao+1;
		}else {
			System.out.println("Questão 4: " + Gabarito4 + " : Errada, resposta correta(c)");
		}
		...
		if("d".equals(Gabarito6)) {
			System.out.println("Questão 6: " + Gabarito6 + " : Correto");
			pontuacao = pontuacao+1;
		}else {
			System.out.println("Questão 6: " + Gabarito6 + " : Errada, resposta correta(d)");
		}
		if("a".equals(Gabarito7)) {
			System.out.println("Questão 7: " + Gabarito7 + " : Correto");
			pontuacao = pontuacao+1;
		}else {
			System.out.println("Questão 7: " + Gabarito7 + " : Errada, resposta correta(a)");
		}
		if("b".equals(Gabarito8)) {
			System.out.println("Questão 8: " + Gabarito8 + " : Correto");
			pontuacao = pontuacao+1;
		}else {
			System.out.println("Questão 8: " + Gabarito8 + " : Errada, resposta correta(b)");
		}
		if("b".equals(Gabarito9)) {
			System.out.println("Questão 9: " + Gabarito9 + " : Correto");
			pontuacao = pontuacao+1;
		}else {
			System.out.println("Questão 9: " + Gabarito9 + " : Errada, resposta correta(b)");
		}
